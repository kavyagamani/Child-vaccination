...
<form name="formID" id="formID" method="post" action="Parents_insert.php">
  <table width="534" height="475" border="0" align="center">
    ...
    <tr>
      ...
      <td width="264"><select name="hospital_id" id="hospital_id" class="form-control validate[required]" >
...
?>
    ...
    <tr>
      ...
      <td><input type="password" name="repassword" id="repassword" onBlur="call()" maxlength="6" class="form-control validate[required]"></td>
    </tr>
    <tr>
