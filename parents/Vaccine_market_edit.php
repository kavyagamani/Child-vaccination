...
<form action="Vaccine_market_update.php" method="post" enctype="multipart/form-data" name="formID" id="formID">
  ...
  <table width="491" height="445" border="0"align="center">
    ...
    <tr>
      <td height="53">Vaccine_Type:</td>
      <td><select name="vtype" id="vtype" class="form-control validate[required]">
      ...
      <td width="198" height="51">Vaccine_Name:</td>
      <td width="277"><select name="vname" id="vname" class="form-control validate[required]">
    ...
    <tr>
      ...
      <td><textarea name="description" id="description" class="form-control validate[required]"
        value="<?php echo $row['description'];?>"></textarea></td>
    </tr>
    <tr>
