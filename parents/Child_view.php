...
$uname=$_SESSION['uname'];
 ...
 $sql="select * from child_info ci,parents p where ci.parent_id=p.parent_id and p.email='$uname'";
...
?> 
  <tr>
    ...
    <td>&nbsp;<a href="Vaccination_cal.php?child_id=<?php echo $row['child_id'];?>" class="btn btn-primary">SHEDULE</a></td>
