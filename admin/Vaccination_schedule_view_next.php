            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">           
              <div class="card mb-3">
                ...
                <div class="card-body">
				  ...
				  <form action="Vaccination_schedule_view_next.php" method="post">
				  Select Cild Name : 
...
$sl=1;
$c_id=$_POST['c_id'];
$sql="select * from vaccination_schedule vs,child_info ci,doctor d,vaccine_master vm,parents p where vs.child_id=ci.child_id and vs.doctor_id=d.doctor_id and vs.v_id=vm.v_id and p.parent_id=ci.parent_id and vs.child_id='$c_id'";
