...
?> 
  <tr>
    ...
    <td>&nbsp;<a href="Vaccine_market_edit.php?v_id=<?php echo $row['v_id'];?>">edit</a></td>
    <td><a href="Vaccine_market_delete.php?v_id=<?php echo $row['v_id'];?>"onclick="return confirm('are u sure want to delete')">delete</a></td>
  </tr>
  <?php
}
?>
