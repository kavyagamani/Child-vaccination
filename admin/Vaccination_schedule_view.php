...
include('../dbconnect/dbconnect.php');
$sl=1;
$sql="select * from vaccination_schedule vs,child_info ci,doctor d,vaccine_master vm,parents p where vs.child_id=ci.child_id and vs.doctor_id=d.doctor_id and vs.v_id=vm.v_id and p.parent_id=ci.parent_id ";
