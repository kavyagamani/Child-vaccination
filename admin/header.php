	...
	<div class="headerbar">
        ...
        <ul class="list-inline float-right mb-0"><li class="list-inline-item dropdown notif">
            ...
            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
              Admin :   <img src="assets/images/avatars/admin.png" alt="Profile image" class="avatar-rounded">
            </a>
...
<marquee  direction="left" behavior="alternate" height="50px" width="80%"scrollamont="10">SAVE CHILD<i class="fa fa-fw fa-child"></i></marquee>                   
